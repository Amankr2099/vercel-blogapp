...
export const Card = ({ card }) => {
  ...
  return (
    <Link to={`/post/${card.blogId}`} className="text-decoration-none"  onClick={()=>{window.scrollTo(0,0)}}>
      ...
      <div className="row g-0">
        ...
        <div className="col-md-8">
          <div className="card-body">
            <h5 className="card-title">{card.blogTitle} </h5>
            {/* <p className="card-text" > {card.content.substring(0, 400)} </p> */}
            <p className="card-text" > {card.blogCaption} </p>
